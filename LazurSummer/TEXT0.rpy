init:
    ...
    image bg cum_room = "mods/Лазурное лето. С нуля/bg/cum_room.jpg"
...
label EvSuPrlg:
    ...
    Нет, я не отрицаю “насыщенную” социальную жизнь и плохого в ней ничего не вижу.{w} Просто каждому своё. Однако, многие считают лишь свое виденье правильным, единственно верным.{w} Нет ничего плохого в асоциальности.{w} Я никого не осуждаю, никому не мешаю и ни к кому не лезу в жизнь – в общем живу никоим образом не затрагивая окружающих. Зато стоит кому-либо узнать мои взгляды на бытие - тут же неприязнь в глазах, тут же летит совет что мне делать.{w}{p} 
    ...
    $ renpy.movie_cutscene("mods/Лазурное лето. С нуля/OP/op1.ogv")
