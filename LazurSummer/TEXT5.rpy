init:
    ...
    image mi smile long hair night = im.MatrixColor( im.Composite((900,1080), (0,0), "mods/Лазурное лето. С нуля/sprites/normal/mi/mi_3_body_loo.png",(0,0), "mods/Лазурное лето. С нуля/sprites/normal/mi/mi_3_casual.png",(0,0), "mods/Лазурное лето. С нуля/sprites/normal/mi/mi_3_smile2.png"), im.matrix.tint(0.63, 0.78, 0.82) )

    image mi dress night = im.MatrixColor( im.Composite((900,1080), (0,0), "mods/Лазурное лето. С нуля/sprites/normal/mi/mi_3_body_loo.png",(0,0), "mods/Лазурное лето. С нуля/sprites/normal/mi/mi_3_dress.png",(0,0), "mods/Лазурное лето. С нуля/sprites/normal/mi/mi_3_smile2.png"), im.matrix.tint(0.63, 0.78, 0.82) )
    
    image mi dress sunset = im.MatrixColor( im.Composite((900,1080), (0,0), "mods/Лазурное лето. С нуля/sprites/normal/mi/mi_3_body_loo.png",(0,0), "mods/Лазурное лето. С нуля/sprites/normal/mi/mi_3_dress.png",(0,0), "mods/Лазурное лето. С нуля/sprites/normal/mi/mi_3_smile2.png"), im.matrix.tint(0.94, 0.82, 1.0) )
    
    image mi dress sad night = im.MatrixColor( im.Composite((900,1080), (0,0), "mods/Лазурное лето. С нуля/sprites/normal/mi/mi_2_body_loo.png",(0,0), "mods/Лазурное лето. С нуля/sprites/normal/mi/mi_2_dress.png",(0,0), "mods/Лазурное лето. С нуля/sprites/normal/mi/mi_sad_3.png"), im.matrix.tint(0.63, 0.78, 0.82) )

    image bg cum_room_day = "mods/Лазурное лето. С нуля/bg/cum_room_day.jpg"
    
    image bg ext_music_club_verandah_day = "mods/Лазурное лето. С нуля/bg/ext_music_club_verandah_day.jpg"
    
    image bg lake = "mods/Лазурное лето. С нуля/bg/lake.jpg"
    
    image bg road_out_camp = "mods/Лазурное лето. С нуля/bg/road_out_camp.jpg"
    
    image bg road_out_camp_day = "mods/Лазурное лето. С нуля/bg/road_out_camp_day.jpg"
    
    image bg inside_music_club_sunset = "mods/Лазурное лето. С нуля/bg/inside_music_club_sunset.jpg"
    
    image bg ext_mimusicclub_night = "mods/Лазурное лето. С нуля/bg/ext_mimusicclub_night.jpg"
    
    image bg houses_night = "mods/Лазурное лето. С нуля/bg/houses_night.jpg"
    
    image bg cum_hata_night = "mods/Лазурное лето. С нуля/bg/cum_hata_night.jpg"
    
    image bg ext_house_of_mi_night = "mods/Лазурное лето. С нуля/bg/ext_house_of_mi_night.jpg"
    
    image bg cum_room_light_night = "mods/Лазурное лето. С нуля/bg/cum_room_light_night.jpg"
    
    image bg cum_room_night = "mods/Лазурное лето. С нуля/bg/cum_room_night.jpg"
    
    image bg cum_hata_day = "mods/Лазурное лето. С нуля/bg/cum_hata_day.jpg"
    
    image bg cum_hata_sunset = "mods/Лазурное лето. С нуля/bg/cum_hata_sunset.jpg"
    
    image bg ext_playground_sunset = "mods/Лазурное лето. С нуля/bg/ext_playground_sunset.jpg"
    
    image bg int_wardrobe = "mods/Лазурное лето. С нуля/bg/int_wardrobe.jpg"
    
    image bg ext_warehouse2_day = "mods/Лазурное лето. С нуля/bg/ext_warehouse2_day.jpg"
    
    image bg cum_room_sunset = "mods/Лазурное лето. С нуля/bg/cum_room_sunset.jpg" 
    
    image bg ext_houses_night = "mods/Лазурное лето. С нуля/bg/ext_houses_night.jpg"
    
    image bg palata = "mods/Лазурное лето. С нуля/bg/palata.jpg"
    
    $ piano = "mods/Лазурное лето. С нуля/music/sister-friede-father-ariandel.mp3"
    
    $ forest = "mods/Лазурное лето. С нуля/music/IC3PEAK_-_Are_you_scared_I_am_not.mp3"
